    ...
    class Buscador_M extends ConexionClasificados_BD{
        ...
        public function consultarBusquedaTienda($Buscar){                                
            $stmt = $this->dbh->prepare(
                "SELECT productos.ID_Producto, ID_Suscriptor, opciones.ID_Opcion, producto, opcion, precioBolivar, precioDolar, nombre_img 
                 FROM productos 
                 ...
                 WHERE producto LIKE '$Buscar%' OR opciones.opcion LIKE '$Buscar%'  
