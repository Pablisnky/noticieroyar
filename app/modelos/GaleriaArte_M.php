    ...
    class GaleriaArte_M extends Conexion_BD{
		...
		public function ConsultarArtista($ID_Suscriptor){
            $stmt = $this->dbh->prepare(
                "SELECT ID_Suscriptor, nombreSuscriptor, apellidoSuscriptor, paisSuscriptor, estadoSuscriptor, nombre_imagenPortafolio
                FROM suscriptores
        ...
        public function consultarUltimoID_Obra($ID_Suscriptor){
            $stmt = $this->dbh->prepare(
                "SELECT ID_Obra, imagenObra, disponible, nombreObra, suscriptores.ID_Suscriptor, anioObra, disponible, coleccionObra, descripcionObra, imagenObra, tecnicaObra, medidaObra, nombreSuscriptor, apellidoSuscriptor, precioDolarObra
                FROM obra
                INNER JOIN suscriptores ON obra.ID_Suscriptor=suscriptores.ID_Suscriptor
