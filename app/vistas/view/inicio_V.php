...
<div class="cont_portada" id="Cont_Portada">
    ...
    foreach($Datos['datosNoticia'] as $Key) :  ?>
        <div class="cont_portada--noticia">
            <div class="borde_1 borde_3" id="Tarjeta_<?php echo $Iterador?>">
        ...
        <div class="cont_portada--botones">
            ...
            <!-- <div>
                <label class="boton boton--corto"><a class="Default_font--white" href="<?php echo RUTA_URL . '/Agenda_C';?>">Eventos</a></label> 
            </div>         -->
            <div>
            ...
            <!-- <div>
                <label class="boton boton--corto"><a class="Default_font--white" href="<?php echo RUTA_URL . '/Clasificados_C';?>">Clasificados</a></label> 
            </div>         -->
            <div>
