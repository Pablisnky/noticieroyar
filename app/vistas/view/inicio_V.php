    ...
    foreach($Datos['datosNoticia'] as $Key) :  ?>
        <div class="cont_portada--noticia contenedor_tarjeta" id="Cont_Portada">
            <div class="tarjeta" id="Tarjeta_<?php echo $Iterador?>">
                <div class="adelante" id="adelante_<?php echo $Iterador?>">
                    <!-- IMAGEN -->
                    ...
                    <!-- <label style="display:inline" class="VerMas_JS">Girar</label> -->
                </div>
                <div class="atras borde_1" id="atras_<?php echo $Iterador?>">
                    <!-- <p style="">COLECCIÓN 180° - Vienes de interes cultural</p>
                    <div style=";">
                        <label class="Cerrar_JS">Girar</label>
                    </div> -->
                </div>
            </div>
        </div>     
