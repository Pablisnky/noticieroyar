...
<header>
    <div class="cont_catalogos">  
        ...
        <div class="cont_catalogos--membrete--2">
            ...
            <h1 class="h1_1 h1_1--catalogo"><?php echo $Datos['Suscriptor'][0]['pseudonimoSuscripto'];?></h1> 
        </div>
    ...
    <div class="cont_catalogos--secciones" id="Con_Secciones">
        ...
        foreach($Datos['secciones'] as $Key) :    ?>
            <a href="<?php echo RUTA_URL . '/Catalogos_C/Secciones/' . $Datos['Suscriptor'][0]['ID_Suscriptor'] . ',' . $Key['ID_Seccion'];?>" onclick="verSecion('<?php echo $Key['ID_Seccion']?>')"><?php echo $Key['seccion']?></a> 
            <br>
            <?php
        endforeach; ?>
        
        <?php $Pseudonimo = str_replace(" ", "_", $Datos['Suscriptor'][0]['pseudonimoSuscripto']); ?>
        <a href="<?php echo RUTA_URL . '/Catalogos_C/Secciones/' . $Datos['Suscriptor'][0]['ID_Suscriptor'] . ',' . $Pseudonimo; ?>" onclick="verSecion('Todos')">Todos</a>
