            ...
            foreach($Datos['noticiasGenerales'] as $Key) : 
                ...
                <div class="cont_noticia--sencilla Default_pointer">
                    ...
                    <div class="cont_noticia--titular">
                        ...
                        <small style="font-weight: bold; font-size: 1em; display: block"><?php echo $Key['fecha'];?></small style="font-size: 0.8em;">
                        <?php
                        foreach($Datos['imagenes'] as $Row_3)   :  
                            if($Key['ID_Noticia'] == $Row_3['ID_Noticia']){ ?> 
                                <small style="font-weight: bold; font-size: 1em; display:"><?php echo $Row_3['cantidad'];?> imagenes</small> 
                                <?php
                            }
                        endforeach; 
                        foreach($Datos['anuncios'] as $Row_2)   :  
                            if($Key['ID_Noticia'] == $Row_2['ID_Noticia']){ ?>
                                <small style="font-weight: bold; font-size: 1em; margin-left: 5px">+ Anuncio</small>
                                <?php
                            }
                        endforeach; ?>
                        <!-- FUENTE -->
                        <!-- <small style="font-size: 1em; display:block; font-weight: bold"><?php echo $Key['fuente'];?></small> -->
