...
<html lang="es">
    <head>
		...
		<meta property="og:image:secure_url" itemprop="image" content="<?php echo RUTA_URL?>/public/video/YaracuyEnVideo/<?php echo $Datos['yaracuyVideo']['nombreVideo'];?>"/>
		...
		<meta name='twitter:image' content='<?php echo RUTA_URL?>/public/video/YaracuyEnVideo/<?php echo $Datos['yaracuyVideo']['nombreVideo'];?>'>
