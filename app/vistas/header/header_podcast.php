...
<html lang="es">
    <head>
		...
		<meta property="og:image" content="<?php echo RUTA_URL?>/public/images/podcast/<?php echo $Datos['podCast']['imagen_redesSociales'];?>"/>

		<!--ETIQUETAS META TWITTER --> 
		<meta name="twitter:card" content="summary_large_image">
		<meta name='twitter:image' content='<?php echo RUTA_URL?>/public/images/podcast/<?php echo $Datos['podCast']['imagen_redesSociales'];?>'>
