...
<html lang="es">
    <head>
		...
		<meta property="og:url" content="<?php echo RUTA_URL?>/GaleriaArte_C/artistas/<?php echo $Datos['datosArtistas']['ID_Artista'];?>"/>
		<meta property="og:image:secure_url" itemprop="image" content="<?php echo RUTA_URL?>/public/images/galeria/<?php echo $Datos['datosArtistas']['ID_Artista'];?>_<?php echo $Datos['datosArtistas']['nombreArtista'];?>_<?php echo $Datos['datosArtistas']['apellidoArtista'];?>/perfil/<?php echo $Datos['datosArtistas']['imagenArtista']?>"/>
		...
		<meta name='twitter:image' content='<?php echo RUTA_URL?>/public/images/galeria/<?php echo $Datos['datosArtistas']['ID_Artista'];?>_<?php echo $Datos['datosArtistas']['nombreArtista'];?>_<?php echo $Datos['datosArtistas']['apellidoArtista'];?>/perfil/<?php echo $Datos['datosArtistas']['imagenArtista']?>'>
