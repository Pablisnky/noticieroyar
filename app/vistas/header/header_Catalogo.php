...
<html lang="es">
    <head>
		...
		<meta property="og:image:secure_url" itemprop="image" content="<?php echo RUTA_URL?>/public/images/clasificados/<?php echo $Datos['ID_Suscriptor']?>/<?php echo $Datos['imgCatalogo']['nombreImgCatalogo'];?>"/>
		...
		<meta name='twitter:image' content='<?php echo RUTA_URL?>/public/images/clasificados/<?php echo $Datos['ID_Suscriptor']?>/<?php echo $Datos['imgCatalogo']['nombreImgCatalogo'];?>'>
