<?php
    class Panel_Artista_C extends Controlador{
        ...
        public function __construct(){
            ...
            $this->Panel_Artista_M = $this->modelo("Panel_Artista_M");
        ...
        public function index($ID_Suscriptor){      
            ...
            $Obras = $this->Panel_Artista_M->consultarObrasArtista($ID_Suscriptor);
            ...
            if($CantidadObras['cantidadObras'] == 0 && $ImagenPortafolio['nombre_imagenPortafolio'] == ''){
                ...
                $this->vista('modal/modal_sinImagenPortafolio_V', $Datos);
                exit;
            }
                ...
                $this->vista("header/header_suscriptor"); 
                $this->vista("suscriptores/suscrip_obras_V", $Datos); 
            }
        }
