...
// *************************************************************************************************
    ...
    function Llamar_EliminarNoticia(ID_Noticia, NombreImagen){
        // console.log("______Desde Llamar_NoticiaPrincipal()______", ID_Noticia + '-' + NombreImagen)
        
        var url = "../Panel_C/eliminar_noticia/" + ID_Noticia + '-' + NombreImagen
