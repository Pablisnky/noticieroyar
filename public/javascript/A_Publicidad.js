...
// *************************************************************************************************
    ...
    function Llamar_EliminarAnuncio(ID_Anuncio, NombreImagen){
        // console.log("______Desde Llamar_EliminarAnuncio()______", ID_Anuncio + '-' + NombreImagen)
        
        var url = "../Panel_C/eliminar_anuncio/" + ID_Anuncio + '-' + NombreImagen
